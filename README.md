...
<!-- stack:badges:start -->
![Laravel](https://img.shields.io/badge/Laravel-13.23-FF2D20?logo=laravel)
...
|-----------|--------|------------|
| Laravel | 13.23.0 | major derivada do Filament |
| Filament | 5.7.5 | pacote limitante |
| Livewire | 4.3.5 | transitivo via Filament — **nunca fixar direto** |
| Pest | 4.7.7 | framework único de testes |
