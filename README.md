...
<!-- stack:badges:start -->
![Laravel](https://img.shields.io/badge/Laravel-13.26-FF2D20?logo=laravel)
...
|-----------|--------|------------|
| Laravel | 13.26.1 | major derivada do Filament |
| Filament | 5.7.6 | pacote limitante |
| Livewire | 4.4.1 | transitivo via Filament — **nunca fixar direto** |
