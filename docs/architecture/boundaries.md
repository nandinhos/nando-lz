...
| Publicador de release | Depois do deploy, relaciona SHA, PR e selo revalidado; cria tag SemVer somente para atualização autônoma elegível. | Extrair cálculo de versão/geração de artefatos se houver múltiplos canais ou pacotes distribuídos. |
