...
| Deploy → publicador de release | SHA da `main`, execução de deploy e PR associada | tag SemVer e GitHub Release somente para `autonomous-candidate` | não publica sem deploy, sem PR elegível, fora da `main` ou em tag duplicada |
